	...
	public partial class Initial : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_UserMedicine", x => new { x.UserId, x.MedicineId });
					table.ForeignKey(
						name: "FK_UserMedicine_AspNetUsers_UserId",
						column: x => x.UserId,
						principalTable: "AspNetUsers",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_UserMedicine_Medicines_MedicineId",
			...
			migrationBuilder.CreateIndex(
				name: "IX_UserMedicine_MedicineId",
				table: "UserMedicine",
				column: "MedicineId");
		}
